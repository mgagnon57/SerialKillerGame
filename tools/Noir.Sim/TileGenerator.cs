...
namespace Noir.Sim
{
    ...
    public static class TileGenerator
    {
        ...
        /// <summary>
        /// EVERY LOOSE SURFACE, AS DATA, so something other than this file can read the list.
        ///
        /// These were sixteen inline SaveSurface calls and the same list existed nowhere else -
        /// which is why a PNG that nothing generated and a name the town asked for that nothing
        /// wrote were both invisible. `SurfaceTextureTests` in the two-minute Core gate now diffs
        /// this table against the files on disk and against the names Materials3D asks for.
        ///
        /// The arguments and their order are unchanged, so the generated bytes are unchanged.
        /// </summary>
        public readonly struct Surface
        {
            public readonly string Name;
            public readonly int R, G, B, Noise, Salt;
            public readonly double Grain;

            public Surface(string name, int r, int g, int b, int noise, double grain, int salt)
            {
                Name = name; R = r; G = g; B = b; Noise = noise; Grain = grain; Salt = salt;
            }
        }
        ...
        public static readonly Surface[] Surfaces =
        {
                ...
                new Surface("grass", 106, 123, 58, 24, 0.12, 1201),
                new Surface("field", 101, 75, 47, 18, 0.55, 1301),
                new Surface("wood", 139, 96, 58, 28, 0.18, 1401),
                new Surface("water", 62, 106, 136, 12, 0.15, 1501),
                new Surface("road", 49, 49, 49, 22, 0.10, 1601),
                new Surface("path", 115, 79, 49, 28, 0.20, 1701),
                new Surface("floor", 218, 205, 189, 14, 0.60, 1801),
                ...
                new Surface("wall", 192, 178, 160, 16, 0.18, 2001),
                new Surface("brick", 167, 105, 78, 20, 0.30, 2501),
                ...
                new Surface("roof_shingle_grey", 64, 64, 64, 14, 0.55, 2101),
                new Surface("roof_shingle_charcoal", 44, 43, 43, 12, 0.55, 2201),
                new Surface("roof_shingle_brown", 105, 70, 42, 20, 0.50, 2301),
                new Surface("roof_shingle_black", 40, 27, 16, 12, 0.50, 2401),
                ...
                new Surface("roof_builtup", 84, 84, 87, 26, 0.05, 2601),
        ...
        public static void GenerateSurfaces(string outputDir)
        {
            ...
            foreach (var s in Surfaces)
                SaveSurface(outputDir, s.Name, s.R, s.G, s.B, s.Noise, s.Grain, s.Salt);

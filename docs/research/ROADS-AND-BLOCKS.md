...
## 5. The one thing still open

Through the downtown, OSM has Route 1 on a constant **+20° bearing**, bending to +6° only about
270 m south of Attica. The parcels say the plat is square to within 2°. Both cannot be the street
the shops front.

Either Route 1 runs down Chicago Street through town and the shops must be re-laid along its
curve, or **Route 1 and Chicago Street are two different alignments** that meet at the crossing —
the highway angling in from the north-west, the town street straight in the grid. The second fits
every measurement here, but it is a change to what the town IS, and wants confirming by somebody
who has driven it.

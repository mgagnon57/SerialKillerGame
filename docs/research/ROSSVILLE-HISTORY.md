...
> and Attica roads, and the two principal streets of the town were named the same as these
> roads.**"*

**The simulation's coordinate origin is the town's own origin.** Chicago Street and Attica Street
are not arbitrary names — they are *the road to Chicago* and *the road to Attica* (Indiana). The
whole town is four blocks at that crossing, plus a century of additions bolted on:

| addition | by whom | size |
|---|---|---|
| **the original town, ~1857** | Alvan Gilbert & Joseph Satterthwait | **4 blocks** at Chicago × Attica |
| addition, 1862 | Gilbert & Satterthwait | *completely surrounded* the original plat |
| addition east | Gilbert | 17 blocks |
| addition east of the original town | **W. T. and W. H. Livingood** | 18 blocks |
| addition north | **W. J. Henderson** | 9 blocks |
| third addition south | Gilbert | — |

Those names are still on the ground: **Henderson Street**, **Livingood's Addition**, **Gilbert
Street**, **Gilbert & Satterthwaite's Addition** are all labelled on the 1913 Sanborn sheets. The
street grid is a family tree.

### Other names the town has had

- **Liggett's Grove** (south) — for John Liggett's 1829 lodging house
- **Bicknell's Point** (north) — the corporate limits later took in both
- **"Henpeck"** — an actual recorded nickname, *"for some unknown reason"*
- The post office was **"North Fork"**, established at Gilbert's in 1839, moved into town in 1853
  with Alvan Gilbert as postmaster, and only renamed Rossville when the town was platted

### The railroad that did *not* come

> *"The building of the LaFayette, Bloomington and Muncie Railroad through the next northern tier
> townships instead of following, as seemed likely, the old traveled road, was a setback to this
> settlement."*

A railroad bypassed Rossville to the north — which is a large part of why **Hoopeston**, not
Rossville, became the bigger town. Rossville had to wait for the C&EI.

### First commerce, at the crossroads

In **1857 Thomas Armstrong and the North Fork Odd Fellows Lodge built a two-storey frame store at
the intersection of the cross-roads** — the Odd Fellows owning the upper floor, which was for
years *"the only 'public hall' in Rossville"*: lodges, religious meetings of every denomination,
and all public gatherings. **That is the ancestor of the pattern the 1913 Sanborn map still shows**
— shops below, lodge rooms above, right at Attica × Chicago.

**W. J. Henderson** arrived 1862 and *"perhaps did more to put Rossville on the map than any other
man, with the possible exception of Alvan Gilbert"* — frame store in 1864, later a large brick
building. **Gideon Davis** built a hotel in 1859 that passed to **Dr. M. T. Livingood**, who
extended it in 1873; it was *"famous in this part of the country as a very good hotel."*

### Dates from the same source
...
> *"Prairie chickens were everywhere. Wild geese were plentiful in the Spring and Fall. There were
> not many deer but wolves were prowling around night and day. Sheep could hardly be protected from
> them. Farmers used to drive their hogs to Chicago to market, the trip taking about ten days."*

## 2. The railroad

The line through Rossville — today **CSX's Woodland Subdivision**, running NNW–SSE on a diagonal —
is labelled **"C. & E. I. R. R."** on the Sanborn maps of 1898 and 1913. Its full descent:

| when | who |
|---|---|
| chartered 1865 | **Chicago, Danville & Vincennes Railroad** |
| **built 1871** | the same |
| **1877** | consolidated into the **Chicago & Eastern Illinois (C&EI)** |
| 1967–69 | C&EI split between Missouri Pacific / Union Pacific and **L&N → CSX** |
| today | **CSX Woodland Subdivision** |

- The **depot was built in 1903** (brick, C&EI). **It was never demolished** — it is the museum.
  **Passenger service ran until 1971.**
- **Comstock & Co. built a 40 × 60 ft grain elevator in 1873**, one to two years after the rails
  arrived (1879 source).

### Why the grid and the railroad disagree — resolved

**The town is fourteen years older than the railroad.** Rossville was platted in **1857** on the
crossing of two *roads* — the Chicago road (Hubbard's Trace) and the Attica road. The railroad did
not arrive until **1871**, and an 1879 source says it ran **"along [the town's] eastern boundary"**
rather than through the platted core.

So the grid was never re-oriented to the tracks, because the grid was already there and the tracks
went round the edge. **The simulation's diagonal rail crossing a cardinal street grid is not an
artefact — it is the actual sequence of history**, and industry accordingly strung itself along the
rail while houses stayed on the streets.

*(Well-supported inference rather than a directly stated fact: no source explicitly says "the grid
was never reoriented." But the plat predates the rail by 14 years and the rail skirted the edge.)*
...
## 7a. The house kit, specified

Combining the 1913 Sanborn sheets (primary, building-by-building) with modern housing statistics
gives an actual specification for the models this project needs.

| statistic | value |
|---|---|
| **median year built** | **1943** |
| built before 1950 | **~54%** |
| **detached single-family** | **82%** — almost no attached or multi-family |
| median home value | **~$92–95k** |

Three layers, and the middle one is the biggest:

1. **The 1857–1910s core** — frame, 1 to 1½ storeys, vernacular farmhouse and American Foursquare,
   each with a small rear outbuilding, on quarter-acre lots. This is what the Sanborn sheets draw,
   and it is *directly observed*, not inferred.
2. **A large 1920s–40s layer** — bungalows and minimal-traditional cottages. The 1943 median says
   this is the single largest cohort, and it is *not* visible on the 1913 maps because it had not
   been built yet.
3. **A minority of postwar ranches**, on the newer edges.

Queen Anne showpieces probably exist but as a **small minority, not the dominant type**. Nothing
residential is brick.

> **Caveat, stated plainly: no architectural survey of Rossville exists.** Layer 1 is documented
> from primary sources. The proportions in layers 2 and 3 are inference from the date profile, and
> should be treated as a sensible default rather than a measurement.

**Also established:** there is **no National Register historic district** in Rossville — the full
Vermilion County NRHP list was checked. And there is **no single large "antique mall" building**;
the antique trade ran out of *many ordinary storefronts*, which is why the 2004 fire could kill it
by taking one block.

## 8. What this changes for the simulation

1. **The houses should be frame, not brick** — and in three dated layers, see §7a. The Sanborn
   colour key settles the material; the 1943 median build year settles the mix. The current asset
   pack offers only Chicago brownstones, which is not a near miss — it is the wrong country.
...
- The **2004 fire date** is given as **27 February** by one research pass and **28 February** by
  another. One day apart; not worth resolving without a newspaper front page.
- An **"Opera House built 1908 by Alexander Bell McRae"** claim surfaced in search results and is
  **probably fabricated** — no corroborating source exists. An opera house certainly existed (it is
  drawn and labelled on the 1913 Sanborn sheet, with a Masonic lodge above it) but **its build date
  and builder are unknown**. Recorded here as a warning: that claim will resurface.
- Several searches returned results for **Rossville, Georgia / Indiana / Tennessee**. Anything
  about "Rossville" that does not also say Vermilion County or Illinois should be distrusted.
